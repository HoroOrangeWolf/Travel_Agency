...
public class DataBaseManager {
	...
	public final  static class WorkerManager{
		 ...
		 * @return zwróci null je¿eli nie znaleziono
		 */
		 ...
		 * @return zwróci null je¿eli nie znaleziono pracownika
		 */
		 ...
		 * @param id
		 * @return true je¿eli usuniêto pracownika
		 */
		 ...
		 * @return true je¿eli aktualizacja siê powiod³a
		 */
	...
	public final static class TripManager{
		private TripManager() {};
		/**
		 * Dodaje wycieczkê do bazy danych
		...
		/**
		 * Usuwa wycieczkê z bazy danych o podanym id
		...
		/**
		 * Aktualizuje wycieczkê danymi zawartymi w obiekcie
	 ...
	 * @see DataBaseManager
	 * <p>
	 * Posiada wszystkie metody pozwalaj¹ce na operowanie na p³atnoœciach w bazie danych
	 */
	public final static class PaymentManager{
		private PaymentManager() {};
		private static Object synch = new Object();
		/**
		 * Dodaje p³atnoœæ do bazy danych
		...
		/**
		 * Zwraca id p³atnoœci po kluczu obcym umowy
		 * @param id id umowy
		...
		/**
		 * Aktualizuje p³atnoœæ o podane w obiekcie dane
		 * @param pay Obiekt z danymi
		 * @return zwraca true je¿eli aktualizacja siê powiod³a
		 */
	...
	public final static class ClientManager{
		 ...
		 * @param idOffice id biura
		 * @param pesel pesel klienta
		 * @return true je¿eli usuniêto klienta pomyœlnie z bazy danych
		 */
	 ...
	 * @see DataBaseManager
	 * <p>
	 * Obs³ugujê logowanie do serwera
	 */
	public static class AdminLoginManager{
		 ...
		 * @param nick login
		 * @param password has³o 
		 * @return true je¿eli aktualizacja przebieg³a pomyœlnie
		 */
	...
	public static final class AgrrementManager{
		...
		/**
		 * Zwraca listê umów z biura, oraz spe³niaj¹cy odpowiednie warunki
		...
		/**
		 * Aktualizuje umowê w oparciu o dane zawarte w obiekcie
