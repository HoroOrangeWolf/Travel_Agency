package com.Michalski.Mosiolek.Minner.Klient;
...
import com.Michalski.Mosiolek.Minner.SerwerConnector.SerwerConnector;
 ...
 * 
 * @author wojci
 * Klasa zawieraj¹ca wygenerowany kod tworz¹cy czêœæ wizualn¹ projektu, oraz inne funkcjonalnoœci
 */
public class Window {
		...
		btnNewButton_11.setBackground(new Color(255, 99, 71));
			...
			btnNewButton_11.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					/*
					 * TODO Dodanie statusu typu p³atnoœci
					 */
					try {
	...
	/**
	 * Pobiera wartoœci z pól, a nastêpnie przesy³a obiekt do Serwera w celu dodania go do bazy danych
	 */
	...
	/**
	 * Wyœwietla b³¹d jaki wyst¹pi³
	 * @param text - tekst b³êdu
	 */
